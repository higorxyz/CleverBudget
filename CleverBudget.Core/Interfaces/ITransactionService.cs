...
{
    Task<IEnumerable<TransactionResponseDto>> GetAllAsync(string userId, TransactionType? type = null, int? categoryId = null, DateTime? startDate = null, DateTime? endDate = null);
